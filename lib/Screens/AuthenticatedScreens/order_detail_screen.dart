...
import 'package:jit_food/widgets/status_banner.dart';

import '../../models/address.dart';
import '../../widgets/shipment_add_design.dart';
                  ...
                  ? Container(
                    child: Column(
                      children: [
                        ...
                        orderStatus == "ended"
                            ? Image.asset("assets/img/png/jit-logo.png")
                            : Image.asset("assets/img/png/no_image.png"),
                        const Divider(thickness: 4,),
